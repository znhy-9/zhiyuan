...
public class FuwujiluVO  implements Serializable {
	...
	private String gongxianxiangqing;
	...
	public void setGongxianxiangqing(String gongxianxiangqing) {
		this.gongxianxiangqing = gongxianxiangqing;
	}
	
	/**
	 * 获取：贡献详情
	 */
	public String getGongxianxiangqing() {
		return gongxianxiangqing;
	}
