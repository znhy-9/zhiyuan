	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="input" v-if="type!='info'"  label="服务人数" prop="fuwurenshu" >
					<el-input v-model="ruleForm.fuwurenshu" placeholder="服务人数" clearable  :readonly="ro.fuwurenshu"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="服务人数" prop="fuwurenshu" >
				...
				<el-form-item class="input" v-if="type!='info'"  label="活动积分" prop="zhiyuanjifen" >
					<el-input v-model.number="ruleForm.zhiyuanjifen" placeholder="活动积分" clearable  :readonly="ro.zhiyuanjifen"></el-input>
				</el-form-item>
			...
			info(id) {
				this.$http({
					...
					if (data && data.code === 0) {
						...
						this.ruleForm.huodongxiangqing = this.ruleForm.huodongxiangqing.replace(reg,'../../../springbootj09hp490/upload');
					} else {
						this.$message.error(data.msg);
					}
				});
