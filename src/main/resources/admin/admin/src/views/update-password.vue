<template>
	<div :style='{"width":"calc(100% - 0px)","padding":"0px 30px 30px","margin":"0 auto","fontSize":"15px","background":"none"}'>
		<el-form
			...
			label-width="180px"
		>
			<el-form-item :style='{"border":"0px solid #eee","width":"49%","padding":"0","margin":"0 0 26px 0","textAlign":"left","display":"inline-block"}' label="原密码" prop="password">
				<el-input type="password" v-model="ruleForm.password" ></el-input>
			</el-form-item>
			<el-form-item :style='{"border":"0px solid #eee","width":"49%","padding":"0","margin":"0 0 26px 0","textAlign":"left","display":"inline-block"}' label="新密码" prop="newpassword">
				<el-input type="password" v-model="ruleForm.newpassword" ></el-input>
			</el-form-item>
			<el-form-item :style='{"border":"0px solid #eee","width":"49%","padding":"0","margin":"0 0 26px 0","textAlign":"left","display":"inline-block"}' label="确认密码" prop="repassword">
