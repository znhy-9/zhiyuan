		...
		<view class="container" :style='{"width":"100%","padding":"0","position":"relative","background":"#fff","height":"100%"}'>
			<view :style='{"width":"100%","padding":"24rpx","background":"#fff","height":"auto"}' class="detail-content">
				...
				<view class="bottom-content bg-white tabbar border shop" :style='{"padding":"0","margin":"40rpx auto","flexWrap":"wrap","background":"none","display":"flex","width":"100%","height":"auto"}'>
					...
					<button :style='{"border":"0","padding":"0 20rpx","margin":"0 10rpx 10rpx 0","color":"rgb(255, 255, 255)","borderRadius":"0 20rpx 0 0","background":"#ae4341","width":"auto","fontSize":"28rpx","height":"80rpx"}' v-if="userid&&isAuth('newstype','私聊')" @tap="chatClick">联系TA</button>
					<button :style='{"border":"0","padding":"0 20rpx","margin":"0 10rpx 10rpx 0","color":"rgb(255, 255, 255)","borderRadius":"0 20rpx 0 0","background":"#ae4341","width":"auto","fontSize":"28rpx","height":"80rpx"}' v-if="!userid&&isAuthFront('newstype','私聊')" @tap="chatClick">联系TA</button>
