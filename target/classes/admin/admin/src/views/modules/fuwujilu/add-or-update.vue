	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="input" v-if="type!='info'"  label="服务地点" prop="fuwudidian" >
					<el-input v-model="ruleForm.fuwudidian" placeholder="服务地点" clearable  :readonly="ro.fuwudidian"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="服务地点" prop="fuwudidian" >
					<el-input v-model="ruleForm.fuwudidian" placeholder="服务地点" readonly></el-input>
				</el-form-item>
				...
				<el-form-item class="input" v-if="type!='info'"  label="活动积分" prop="zhiyuanjifen" >
					<el-input v-model="ruleForm.zhiyuanjifen" placeholder="活动积分" clearable  :readonly="ro.zhiyuanjifen"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="活动积分" prop="zhiyuanjifen" >
					<el-input v-model="ruleForm.zhiyuanjifen" placeholder="活动积分" readonly></el-input>
				</el-form-item>
			...
			<el-form-item v-if="type!='info'"  label="贡献详情" prop="gongxianxiangqing" >
				<editor 
					style="min-width: 200px; max-width: 600px;"
					v-model="ruleForm.gongxianxiangqing" 
					class="editor"
					myQuillEditor="gongxianxiangqing"
					action="file/upload">
				</editor>
			</el-form-item>
			<el-form-item v-else-if="ruleForm.gongxianxiangqing" label="贡献详情" prop="gongxianxiangqing" >
				<span class="text ql-snow ql-editor" v-html="ruleForm.gongxianxiangqing"></span>
			</el-form-item>
			...
			init(id,type) {
				...
				if(this.type=='info'||this.type=='else'||this.type=='msg'){
					...
					for (var o in obj){
						...
						if(o=='fuwudidian'){
							this.ruleForm.fuwudidian = obj[o];
							this.ro.fuwudidian = true;
							continue;
						}
						if(o=='fuwushizhang'){
						...
						if(o=='gongxianxiangqing'){
							this.ruleForm.gongxianxiangqing = obj[o];
							this.ro.gongxianxiangqing = true;
							continue;
						}
						if(o=='dengjishijian'){
			...
			info(id) {
				this.$http({
					...
					if (data && data.code === 0) {
						...
						this.ruleForm.gongxianxiangqing = this.ruleForm.gongxianxiangqing.replace(reg,'../../../springbootj09hp490/upload');
					} else {
						this.$message.error(data.msg);
					}
				});
