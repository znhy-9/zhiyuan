		...
		<view class="container" :style='{"width":"100%","padding":"0","position":"relative","background":"#fff","height":"100%"}'>
			...
			<view :style='{"width":"100%","padding":"24rpx","background":"#fff","height":"auto"}' class="detail-content">
				...
				<view class="detail-list-item" :style='{"boxShadow":"2rpx 0px 0px 0px #DCD0C050, 0px 2rpx 0px 0px #B1938B50, -2rpx 0px 0px 0px #98737350, 0px 0px 0px 2rpx #DA635D50","padding":"0 0 0 10rpx","margin":"0 0 24rpx 0","borderColor":"#ccc","borderRadius":"0 60rpx 0 0","borderWidth":"0 0 0px 0","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
					<view class="lable" :style='{"padding":"0 20rpx 0 0","whiteSpace":"nowrap","color":"#333","textAlign":"right","width":"auto","lineHeight":"80rpx","fontSize":"28rpx"}'>兑换数量：</view>
					<view class="text" :style='{"padding":"0px","margin":"0px","lineHeight":"80rpx","fontSize":"28rpx","color":"rgb(0, 0, 0)"}' >{{detail.lipinshuliang}}</view>
				</view>
				<view class="detail-list-item" :style='{"boxShadow":"2rpx 0px 0px 0px #DCD0C050, 0px 2rpx 0px 0px #B1938B50, -2rpx 0px 0px 0px #98737350, 0px 0px 0px 2rpx #DA635D50","padding":"0 0 0 10rpx","margin":"0 0 24rpx 0","borderColor":"#ccc","borderRadius":"0 60rpx 0 0","borderWidth":"0 0 0px 0","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
					<view class="lable" :style='{"padding":"0 20rpx 0 0","whiteSpace":"nowrap","color":"#333","textAlign":"right","width":"auto","lineHeight":"80rpx","fontSize":"28rpx"}'>所需积分：</view>
					<view class="text" :style='{"padding":"0px","margin":"0px","lineHeight":"80rpx","fontSize":"28rpx","color":"rgb(0, 0, 0)"}' >{{detail.suoxujifen}}</view>
				</view>
				<view class="detail-list-item" :style='{"boxShadow":"2rpx 0px 0px 0px #DCD0C050, 0px 2rpx 0px 0px #B1938B50, -2rpx 0px 0px 0px #98737350, 0px 0px 0px 2rpx #DA635D50","padding":"0 0 0 10rpx","margin":"0 0 24rpx 0","borderColor":"#ccc","borderRadius":"0 60rpx 0 0","borderWidth":"0 0 0px 0","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
					<view class="lable" :style='{"padding":"0 20rpx 0 0","whiteSpace":"nowrap","color":"#333","textAlign":"right","width":"auto","lineHeight":"80rpx","fontSize":"28rpx"}'>总积分：</view>
				...
				<view class="detail-list-item" :style='{"boxShadow":"2rpx 0px 0px 0px #DCD0C050, 0px 2rpx 0px 0px #B1938B50, -2rpx 0px 0px 0px #98737350, 0px 0px 0px 2rpx #DA635D50","padding":"0 0 0 10rpx","margin":"0 0 24rpx 0","borderColor":"#ccc","borderRadius":"0 60rpx 0 0","borderWidth":"0 0 0px 0","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
					<view class="lable" :style='{"padding":"0 20rpx 0 0","whiteSpace":"nowrap","color":"#333","textAlign":"right","width":"auto","lineHeight":"80rpx","fontSize":"28rpx"}'>剩余积分：</view>
					<view class="text" :style='{"padding":"0px","margin":"0px","lineHeight":"80rpx","fontSize":"28rpx","color":"rgb(0, 0, 0)"}' >{{detail.shengyujifen}}</view>
				</view>
				<view class="detail-list-item" :style='{"boxShadow":"2rpx 0px 0px 0px #DCD0C050, 0px 2rpx 0px 0px #B1938B50, -2rpx 0px 0px 0px #98737350, 0px 0px 0px 2rpx #DA635D50","padding":"0 0 0 10rpx","margin":"0 0 24rpx 0","borderColor":"#ccc","borderRadius":"0 60rpx 0 0","borderWidth":"0 0 0px 0","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
					<view class="lable" :style='{"padding":"0 20rpx 0 0","whiteSpace":"nowrap","color":"#333","textAlign":"right","width":"auto","lineHeight":"80rpx","fontSize":"28rpx"}'>兑换时间：</view>
					<view class="text" :style='{"padding":"0px","margin":"0px","lineHeight":"80rpx","fontSize":"28rpx","color":"rgb(0, 0, 0)"}' >{{detail.duihuanshijian}}</view>
				</view>
				...
				<view class="bottom-content bg-white tabbar border shop" :style='{"padding":"0","margin":"40rpx auto","flexWrap":"wrap","background":"none","display":"flex","width":"100%","height":"auto"}'>
					...
					<button :style='{"border":"0","padding":"0 20rpx","margin":"0 10rpx 10rpx 0","color":"rgb(255, 255, 255)","borderRadius":"0 20rpx 0 0","background":"#ae4341","width":"auto","fontSize":"28rpx","height":"80rpx"}' v-if="userid&&isAuth('jifenduihuan','私聊')" @tap="chatClick">联系TA</button>
					<button :style='{"border":"0","padding":"0 20rpx","margin":"0 10rpx 10rpx 0","color":"rgb(255, 255, 255)","borderRadius":"0 20rpx 0 0","background":"#ae4341","width":"auto","fontSize":"28rpx","height":"80rpx"}' v-if="!userid&&isAuthFront('jifenduihuan','私聊')" @tap="chatClick">联系TA</button>
		...
		methods: {
			...
			async init(type=1){
				...
				if(type==2){
					...
					await this.$api.update('jifenduihuan',this.detail)
				}
			},
